...
public class PortfolioView {
    ...
    public void showSellDialog(Share share) {
        ...
        sellTitleLabel.setText("Sell " + share.getStock().getSymbol());
        sellSubtitleLabel.setText(share.getStock().getCompany()
            + " · Quantity: " + formatQuantity(share.getQuantity())
            + " · Avg cost: " + formatCurrency(share.getPurchasePrice()));
        updateSellPreview();
    ...
    private static final class ShareRow {
        ...
        private ShareRow(Share share) {
            this.share = share;
            this.symbol = new SimpleStringProperty(share.getStock().getSymbol());
            this.company = new SimpleStringProperty(share.getStock().getCompany());
            this.quantity = new SimpleObjectProperty<>(share.getQuantity());
            this.avgCost = new SimpleObjectProperty<>(share.getPurchasePrice());
