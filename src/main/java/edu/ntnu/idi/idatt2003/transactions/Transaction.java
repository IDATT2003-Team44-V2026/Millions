 ...
 * {@link TransactionCalculator} to compute its financial values. Each transaction is unique and can
 * only be committed once; the {@code committed} flag prevents duplicate execution.</p>
 *
...
public abstract class Transaction {
   ...
   * @param calculator the calculator used to compute values and costs; must not be {@code null}
   * @throws IllegalArgumentException if {@code share} is {@code null}, if {@code week} is negative,
   ...
   * {@link edu.ntnu.idi.idatt2003.transactions.TransactionArchive TransactionArchive} and marks it
   * as committed. A transaction can only be committed once.</p>
   *
